...
<html lang="en">
	...
	<body>
		...
		<header class="mui-bar mui-bar-nav aui-header b-line">
			...
			<h1 class="mui-title" style="height: 100%;">
				<div class="mui-segmented-control" style="width: 60%">
					<a class="mui-control-item mui-active" herf="#nav_1">未完成订单</a>
					<a class="mui-control-item" href="#nav_2">历史订单</a>
				</div>
			</h1>
		</header>
		...
		<script src="orderList.js?v=1.0.0"></script>
