			...
			mui.ajax(GLOBAL.SERVER_URL + "api/station/stations", {
				...
				success: function(data) {
					...
					$.each(data.data, function(index, result) {
						...
						if(result.district == "1") {
							html += "<td>华东地区</td>";
						}
						if(result.district == "2") {
							html += "<td>华南地区</td>";
						}
						if(result.district == "3") {
							html += "<td>华中地区</td>";
						}
						if(result.district == "4") {
							html += "<td>华北地区</td>";
						}
						if(result.district == "5") {
							html += "<td>西北地区</td>";
						}
						if(result.district == "6") {
							html += "<td>西南地区</td>";
						}
						if(result.district == "7") {
							html += "<td>东北地区</td>";
						}
						if(result.district == "8") {
							html += "<td>台港澳地区</td>";
						}
