			...
			mui.ajax(GLOBAL.SERVER_URL + "api/service/services", {
				...
				success: function(data) {
					...
					$.each(data.data, function(index, result) {
						...
						if(result.name == '1') {
							html += "<option value='" + result.id + "'>检测服务" + "-" + result.description + "</option>";
						}
						if(result.name == '2') {
							html += "<option value='" + result.id + "'>产品销售" + "-" + result.description + "</option>";
						}
						if(result.name == '3') {
							html += "<option value='" + result.id + "'>租赁服务" + "-" + result.description + "</option>";
						}
						if(result.name == '4') {
							html += "<option value='" + result.id + "'>救援服务" + "-" + result.description + "</option>";
						}
						if(result.name == '5') {
							html += "<option value='" + result.id + "'>维保服务" + "-" + result.description + "</option>";
						}
