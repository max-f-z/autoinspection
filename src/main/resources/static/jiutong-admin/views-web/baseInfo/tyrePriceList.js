			...
			mui.ajax(GLOBAL.SERVER_URL + "api/tireprice/search", {
				...
				success: function(data) {
					...
					$.each(data.data, function(index, result) {
						...
						html += "<td><button type='button' style='margin-left:5px' class='btn btn-info' onclick='tyrePriceList.service.doDelete(" + result.id + ")'>删除</button><button style='margin-right:5px' type='button' class='btn btn-info' onclick='tyrePriceList.service.doEdit(" + result.id + ")'>查看</button></td>";
						html += "</tr>";
					});
					tbody.append(html);
				}
