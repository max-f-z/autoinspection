...
public interface AppointmentMapper {
	int insertAppointment(InspectionEntity entity);
	int insertAppointmentWx(AppointmentEntity entity);
	...
	List<RegistrationDisplayEntity> listRegistrationsForAdmin(@Param("regDate") String regDate);
	...
	List<RegistrationDisplayEntity> searchForAdmin(@Param("regDate") String regDate, @Param("search") String search);
	String getSlotNameById(@Param("id") Integer id);
}
